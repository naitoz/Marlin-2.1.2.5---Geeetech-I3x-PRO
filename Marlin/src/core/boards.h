...
#define BOARD_ZNP_ROBIN_NANO_V1_3     5254  // Elegoo Neptune 2 v1.3 board
#define BOARD_MKS_NEPTUNE_X           5255  // Elegoo Neptune X
#define BOARD_ZNP_ROBIN_NANO          5256  // Elegoo Neptune 2 v1.2 board
